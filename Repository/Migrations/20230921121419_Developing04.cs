...
{
    public partial class Developing04 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MN_Companies_PD_Stocks_StockId",
                        column: x => x.StockId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PD_EquipamentTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PD_EquipamentTypes_MN_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "MN_Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PD_Products_PD_EquipamentTypes_NameId",
                        column: x => x.NameId,
                        principalTable: "PD_EquipamentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PD_Products_PD_Stocks_StockId",
                        column: x => x.StockId,
                        principalTable: "PD_Stocks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PD_EquipamentTypes_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PD_Products_NameId",
                table: "PD_Products",
                column: "NameId");

            migrationBuilder.CreateIndex(
                name: "IX_PD_Products_StockId",
                table: "PD_Products",
                column: "StockId");
