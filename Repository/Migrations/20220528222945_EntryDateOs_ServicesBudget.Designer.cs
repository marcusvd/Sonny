...
namespace Repository.Migrations
{
    ...
    [Migration("20220528222945_EntryDateOs_ServicesBudget")]
    partial class EntryDateOs_ServicesBudget
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ImgPath", b =>
                {
                    ...
                    b.Property<int?>("NetworkDevicesId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.NetworkDevices", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Partner", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Today = new DateTime(2022, 5, 28, 19, 29, 43, 431, DateTimeKind.Local).AddTicks(9260)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            ToSeach = "Perfect print Luiz Junior",
                            Today = new DateTime(2022, 5, 28, 19, 29, 43, 434, DateTimeKind.Local).AddTicks(2587)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ImgPath", b =>
                {
                    b.HasOne("Domain.Entities.NetworkDevices", null)
                        .WithMany("Images")
                        .HasForeignKey("NetworkDevicesId");
                });
            ...
            modelBuilder.Entity("Domain.Entities.NetworkDevices", b =>
                {
                    b.HasOne("Domain.Entities.ClientEntity", null)
