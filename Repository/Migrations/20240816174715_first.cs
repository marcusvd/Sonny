...
namespace Repository.Migrations
{
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "FN_FinancingsAndLoansExpensesTrackings",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FN_FinancingsAndLoansExpensesTrackings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FN_FinancingsAndLoansExpensesTrackings_aspnetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "aspnetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FN_FinancingsAndLoansExpensesTrackings_FN_BankAccount_BankAc~",
                        column: x => x.BankAccountId,
                        principalTable: "FN_BankAccount",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FN_FinancingsAndLoansExpensesTrackings_FN_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "FN_Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FN_FinancingsAndLoansExpensesTrackings_FN_FinancingsAndLoans~",
                        column: x => x.FinancingAndLoanExpenseId,
                        principalTable: "FN_FinancingsAndLoansExpenses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FN_FinancingsAndLoansExpensesTrackings_FN_Pixes_PixId",
                        column: x => x.PixId,
                        principalTable: "FN_Pixes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FN_FinancingsAndLoansExpensesTrackings_MN_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "MN_Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "FN_MonthlyFixedExpensesTrackings",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    MonthlyFixedExpenseId = table.Column<int>(type: "int", nullable: false),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: true),
                    BankAccountId = table.Column<int>(type: "int", nullable: true),
                    CardId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FN_MonthlyFixedExpensesTrackings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FN_MonthlyFixedExpensesTrackings_aspnetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "aspnetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FN_MonthlyFixedExpensesTrackings_FN_BankAccount_BankAccountId",
                        column: x => x.BankAccountId,
                        principalTable: "FN_BankAccount",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FN_MonthlyFixedExpensesTrackings_FN_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "FN_Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FN_MonthlyFixedExpensesTrackings_FN_MonthlyFixedExpenses_Mon~",
                        column: x => x.MonthlyFixedExpenseId,
                        principalTable: "FN_MonthlyFixedExpenses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FN_MonthlyFixedExpensesTrackings_FN_Pixes_PixId",
                        column: x => x.PixId,
                        principalTable: "FN_Pixes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FN_MonthlyFixedExpensesTrackings_MN_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "MN_Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    YearlyFixedExpenseId = table.Column<int>(type: "int", nullable: false),
                    Start = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: true),
                    BankAccountId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FN_FinancingsAndLoansExpensesTrackings_BankAccountId",
                table: "FN_FinancingsAndLoansExpensesTrackings",
                column: "BankAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_FinancingsAndLoansExpensesTrackings_CardId",
                table: "FN_FinancingsAndLoansExpensesTrackings",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_FinancingsAndLoansExpensesTrackings_CompanyId",
                table: "FN_FinancingsAndLoansExpensesTrackings",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_FinancingsAndLoansExpensesTrackings_FinancingAndLoanExpen~",
                table: "FN_FinancingsAndLoansExpensesTrackings",
                column: "FinancingAndLoanExpenseId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_FinancingsAndLoansExpensesTrackings_PixId",
                table: "FN_FinancingsAndLoansExpensesTrackings",
                column: "PixId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_FinancingsAndLoansExpensesTrackings_UserId",
                table: "FN_FinancingsAndLoansExpensesTrackings",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FN_MonthlyFixedExpensesTrackings_BankAccountId",
                table: "FN_MonthlyFixedExpensesTrackings",
                column: "BankAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_MonthlyFixedExpensesTrackings_CardId",
                table: "FN_MonthlyFixedExpensesTrackings",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_MonthlyFixedExpensesTrackings_CompanyId",
                table: "FN_MonthlyFixedExpensesTrackings",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_MonthlyFixedExpensesTrackings_MonthlyFixedExpenseId",
                table: "FN_MonthlyFixedExpensesTrackings",
                column: "MonthlyFixedExpenseId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_MonthlyFixedExpensesTrackings_PixId",
                table: "FN_MonthlyFixedExpensesTrackings",
                column: "PixId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_MonthlyFixedExpensesTrackings_UserId",
                table: "FN_MonthlyFixedExpensesTrackings",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FN_YearlyFixedExpensesTrackings_YearlyFixedExpenseId",
                table: "FN_YearlyFixedExpensesTrackings",
