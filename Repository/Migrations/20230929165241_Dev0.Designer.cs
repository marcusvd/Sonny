...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Product.EquipamentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Product.Manufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Product.Quantity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Product.Stock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Product.Tracking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.ServicesBench.BudgetService", b =>
                {
                    ...
                    b.Property<DateTime>("BudgetOpen")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("Domain.Entities.ServicesBench.CollectDeliverCosts", b =>
                {
                    ...
                    b.Property<decimal>("ApartPrice")
                        .HasColumnType("decimal(65,30)");

                    b.Property<int>("CostFrom")
                        .HasColumnType("int");

                    b.Property<bool>("IsHaveCost")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("Domain.Entities.Main.Companies.Company", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Product.Stock", "Stock")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Product.Product", b =>
                {
                    b.HasOne("Domain.Entities.Product.Manufacturer", "Manufacturer")
                        .WithMany("Products")
                        .HasForeignKey("ManufacturerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Product.EquipamentType", "Name")
                        .WithMany("Products")
