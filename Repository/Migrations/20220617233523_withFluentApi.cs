        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Transporter = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Noregisterd = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NetworkDevices_Clients_ClientEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    img = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NetworkDevicesId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImgPath", x => x.id);
                    table.ForeignKey(
                        name: "FK_ImgPath_NetworkDevices_NetworkDevicesId",
                        column: x => x.NetworkDevicesId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, "Belo Horizonte", "", "Pompéia", "95", "MG", "R. Veredinha", "30280-520" },
                    { 6, "Belo Horizonte", "", "Horizontes", "4678", "MG", "R. Camanducaia", "98989-4856" },
                    { 7, "-------------", "", "-------------", "-------------", "-------------", "-------------", "-------------" },
                    { 8, "Belo Horizonte", "", "Milionários", "25", "MG", " R. Maringá", "30620-270" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImgPath_NetworkDevicesId",
                table: "ImgPath",
                column: "NetworkDevicesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NetworkDevices_ClientEntityId",
