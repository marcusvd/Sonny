...
{
    /// <inheritdoc />
    public partial class variable_changed : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WithdrawnOn = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FN_CashWithdrawnExpenses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FN_CashWithdrawnExpenses_FN_BankAccount_BankAccountId",
                        column: x => x.BankAccountId,
                        principalTable: "FN_BankAccount",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FN_CashWithdrawnExpenses_FN_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "FN_Cards",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FN_CashWithdrawnExpenses_FN_CategoriesExpenses_CategoryExpen~",
                        column: x => x.CategoryExpenseId,
                        principalTable: "FN_CategoriesExpenses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FN_CashWithdrawnExpenses_FN_Pixes_PixId",
                        column: x => x.PixId,
                        principalTable: "FN_Pixes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FN_CashWithdrawnExpenses_FN_SubcategoriesExpenses_Subcategor~",
                        column: x => x.SubcategoryExpenseId,
                        principalTable: "FN_SubcategoriesExpenses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FN_CashWithdrawnExpenses_MN_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "MN_Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FN_CashWithdrawnExpenses_aspnetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "aspnetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashWithdrawnExpenseId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FN_CreditCardExpenses_FN_CashWithdrawnExpenses_CashWithdrawn~",
                        column: x => x.CashWithdrawnExpenseId,
                        principalTable: "FN_CashWithdrawnExpenses",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FN_PixExpenses_FN_CashWithdrawnExpenses_CashWithdrawnExpense~",
                        column: x => x.CashWithdrawnExpenseId,
                        principalTable: "FN_CashWithdrawnExpenses",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FN_CashWithdrawnExpenses_BankAccountId",
                table: "FN_CashWithdrawnExpenses",
                column: "BankAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_CashWithdrawnExpenses_CardId",
                table: "FN_CashWithdrawnExpenses",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_CashWithdrawnExpenses_CategoryExpenseId",
                table: "FN_CashWithdrawnExpenses",
                column: "CategoryExpenseId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_CashWithdrawnExpenses_CompanyId",
                table: "FN_CashWithdrawnExpenses",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_CashWithdrawnExpenses_PixId",
                table: "FN_CashWithdrawnExpenses",
                column: "PixId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_CashWithdrawnExpenses_SubcategoryExpenseId",
                table: "FN_CashWithdrawnExpenses",
                column: "SubcategoryExpenseId");

            migrationBuilder.CreateIndex(
                name: "IX_FN_CashWithdrawnExpenses_UserId",
                table: "FN_CashWithdrawnExpenses",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FN_CreditCardExpenses_CashWithdrawnExpenseId",
                table: "FN_CreditCardExpenses",
                column: "CashWithdrawnExpenseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FN_PixExpenses_CashWithdrawnExpenseId",
