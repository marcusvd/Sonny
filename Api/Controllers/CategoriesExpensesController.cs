...
namespace Api.Controllers
{
    ...
    public class CategoryExpensesController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddCategoryExpenses([FromBody] CategoryExpenseDto entityDto)
        {
        ...
        public async Task<IActionResult> UpdateCategoryExpenses(int categoryExpensesId, [FromBody] CategoryExpenseDto entityDto)
        {
