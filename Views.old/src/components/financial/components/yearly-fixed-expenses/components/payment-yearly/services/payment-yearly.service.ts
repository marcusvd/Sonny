...
export class PaymentYearlyService extends BackEndService<YearlyFixedExpenseDto>{
  ...
  update(form: FormGroup) {
    ...
    this.update$<YearlyFixedExpenseDto>('UpdateYearlyFixedExpense', toSave).subscribe({
      next: (_cli: any) => {
