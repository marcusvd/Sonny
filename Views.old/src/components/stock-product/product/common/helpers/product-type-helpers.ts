...
// export const ex_measures = [
  
//   { id: 0, name: 'Não especificado' }, { id: 1, name: '(Hz)' }, { id: 2, name: '(Khz)' }, { id: 3, name: '(Mhz)' }, { id: 4, name: '(Ghz)' }, { id: 5, name: '(Thz)' }, { id: 6, name: '(Rpm)' }, { id: 7, name: '(Kbps)' }, { id: 8, name: '(Mbps)' }, { id: 9, name: '(Gbps)' },
//   { id: 10, name: '(Kb)' }, { id: 11, name: '(Mb)' }, { id: 12, name: '(Gb)' }, { id: 13, name: '(Tb)' }, { id: 14, name: '(Volt V)' }, { id: 15, name: '(Watt W)' }
