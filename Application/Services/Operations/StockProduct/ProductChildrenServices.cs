    ...
    public class ProductChildrenServices : IProductChildrenServices
    {
        ...
        public async Task<List<SegmentDto>> GetSegmentsAsync(int companyId)
        {
            var fromDb = await _GENERIC_REPO.Segments.Get(
                predicate =>
                 predicate.CompanyId == companyId && predicate.Deleted == DateTime.MinValue,
        ...
        public async Task<List<SpecificitiesDto>> GetSpecificitiesAsync(int companyId)
        {
            var fromDb =  await _GENERIC_REPO.Specificities.Get(
                 predicate =>
                 predicate.CompanyId == companyId  && predicate.Deleted == DateTime.MinValue,
            ...
            return _IStockProductObjectMapperServices.SpecificitiesListMake(fromDb);
        }
