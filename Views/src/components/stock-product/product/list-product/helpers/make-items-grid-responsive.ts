...
export function ex_makeItemsGridSmall(x: ProductList[]) {
...
export function ex_makeItemsGridLager(x: ProductList[], _truncatePipe: TruncatePipe,) {
...
export function ex_makeItemsGridMedium(x: ProductList[], _truncatePipe: TruncatePipe,) {
...
export function ex_isTested(value: string) {
