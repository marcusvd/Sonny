...
@Component({
  selector: 'upd-manufacturer-mat-select-single',
  standalone: true,
  imports: [
    MatSelectModule,
  ...
  templateUrl: './upd-manufacturer-mat-select-single.component.html',
  styles: [`

  `],
})
export class UpdManufacturerMatSelectSingleComponent extends BaseForm {
