...
@Component({
  selector: 'upd-model-mat-select-single',
  standalone: true,
  imports: [
    MatSelectModule,
  ...
  templateUrl: './upd-model-mat-select-single.component.html',
  styles: [`

  `],
})
export class UpdModelMatSelectSingleComponent extends BaseForm {
