...
@Component({
  ...
  providers: [
    MonthlyFixedExpensesTrackingListService,
    PtBrDatePipe,
    PtBrCurrencyPipe,
  ]

})
export class MonthlyFixedExpensesTrackingListComponent extends List implements OnInit, AfterViewInit {
  constructor(
    ...
    override _listServices: MonthlyFixedExpensesTrackingListService
