...
@Component({
  ...
  templateUrl: './view-monthly-fixed-expenses-tracking.component.html',
  styleUrls: ['./view-monthly-fixed-expenses-tracking.component.css']
})
export class ViewMonthlyFixedExpensesTrackingComponent extends View implements OnInit {
  ...
  constructor(
    ...
    private _services: ViewMonthlyFixedExpensesTrackingService,
