...
export class MonthExpensesTrackingListFilter {
    ...
    // entities: MonthFixedExpensesTrackingListGridDto[];
    // entitiesObservable: Observable<MonthFixedExpensesTrackingListGridDto[]>
    
    //  currentMonthAndYear(value: string, entitiesObservable: Observable<MonthFixedExpensesTrackingListGridDto[]>) {
    //     this.entities =[];
    //     const expiration = new Date(value);
