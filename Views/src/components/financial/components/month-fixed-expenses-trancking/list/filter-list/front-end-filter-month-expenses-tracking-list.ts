...
export class FrontEndFilterMonthExpensesTrackingList {
  ...
  selectedMonth(entities: MonthFixedExpensesTrackingListGridDto[], currentPage: number, pageSize: number, selectedMonth: number,) {
  ...
  getAllLessThanOrEqualCurrentDate(entities: MonthFixedExpensesTrackingListGridDto[], currentPage: number, pageSize: number) {
  ...
  isExpires(entities: MonthFixedExpensesTrackingListGridDto[], selectedMonth: number, currentPage: number, pageSize: number) {
    if (selectedMonth == -1) {
      const result = entities.filter(x =>
        //check Year
        (this.currentDate.getFullYear() == new Date(x.expiration).getFullYear())
  ...
  isPending(entities: MonthFixedExpensesTrackingListGridDto[], selectedMonth: number, currentPage: number, pageSize: number) {
  ...
  isPaid(entities: MonthFixedExpensesTrackingListGridDto[], selectedMonth: number, currentPage: number, pageSize: number) {
    if (selectedMonth == -1) {
      const result = entities.filter(x =>
        //check Year
        (this.currentDate.getFullYear() == new Date(x.expiration).getFullYear())
  ...
  searchField(entities: MonthFixedExpensesTrackingListGridDto[], selectedMonth: number, currentPage: number, pageSize: number, term: string) {
    if (selectedMonth == -1) {
      const result = entities.filter(x =>
        //check Year
        (this.currentDate.getFullYear() == new Date(x.expiration).getFullYear())
  ...
  isdescending = true;
  orderByFrontEnd(entities$: Observable<MonthFixedExpensesTrackingListGridDto[]>, field: string) {
