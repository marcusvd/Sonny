...
import { ImportsAddVariableExpenses,  ProvidersAddVariable } from '../imports/add-variable-expenses.imports';
import { AddDefaultImports, AddDefaultProviders } from '../../../../../imports/components-default.imports';

@Component({
  selector: 'add-variable-expenses',
  templateUrl: './add-variable-expenses.component.html',
  styleUrls: ['./add-variable-expenses.component.css'],
  standalone: true,
  imports: [
    AddDefaultImports,
...
export class AddVariableExpensesAddComponent extends Payment implements OnInit {
