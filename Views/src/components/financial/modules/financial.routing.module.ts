...
import { FixedExpensesTranckingListComponent } from "../components/fixed-expenses-trancking/list/fixed-expenses-trancking-list.component";
...
const Routes: Routes = [
  {
    path: '', component: FinancialDashComponent, children: [
      ...
      { path: 'fixed-expenses-trancking-list', component: FixedExpensesTranckingListComponent },
