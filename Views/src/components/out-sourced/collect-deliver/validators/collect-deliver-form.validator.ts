...
import { CollectDeliverValidators } from "src/components/out-sourced/collect-deliver-old/validators/collect-deliver-validators";
...
export class CollectDeliverFormValidator extends BaseForm {
